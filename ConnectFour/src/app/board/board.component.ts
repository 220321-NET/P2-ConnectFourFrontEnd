...
export class BoardComponent implements OnInit {
  ...
  updatePlayerstoDB(): void {
    console.log(this.Player1Rank);
    console.log(this.Player2Rank);
  ...
  getWinnerName(winner: number): void {
    ...
    this.api.getFullRank(this.Player1.PlayerID).subscribe((res : ranking) => {
      this.Player1Rank = res;
      console.log(this.Player1Rank);
      this.api.getFullRank(this.Player2.PlayerID).subscribe((res : ranking) => {
